...
- [Open Payments](https://openpayments.org/)
...
- [Offerwall tool](https://webmonetization.org/publishers/offerwall-tool/)
- [Per per article Tool](https://webmonetization.org/publishers/paywall-tool/)
- [Widget tool](https://webmonetization.org/publishers/widget-tool/)
...
- [Wordpress plugin](https://webmonetization.org/publishers/wordpress/)
