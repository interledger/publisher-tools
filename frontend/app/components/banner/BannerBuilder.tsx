...
import { toolState, useCurrentConfig } from '~/stores/toolStore'
...
function ContentBuilder({ onRefresh }: Props) {
  ...
  const [snap, profile] = snapshot({ sync: true })
