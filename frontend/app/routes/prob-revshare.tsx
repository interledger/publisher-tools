          ...
          <div className="flex flex-col justify-start gap-4 px-4 mt-md">
            ...
            <div>
              <p className="text-sm leading-sm text-field-helpertext-default">
                ...
                on their assigned weight. The weight is translated to a
                percentage which represents the percent of revenue each
                recipient will receive over time. The higher the weight, the
                ...
                will be 17% (weight 1), 33% (weight 2), and 50% (weight 3).{' '}
                <br />
            ...
            <div>
              ...
              <p className="text-sm leading-sm text-field-helpertext-default">
                Enter each payment pointer and wallet address that will receive
                a split of the revenue into the table. Names are optional. Click{' '}
                <a>Add Share</a> to add more rows. Assign a weight to each
                recipient. If you&apos;d rather assign sharing by percentage,
                enter at least two recipients into the table. The Percent field
                will open for edits. When you&apos;re finished, add the
                generated monetization <a>link</a> tag to your site. The link
                contains a unique URL hosted on{' '}
